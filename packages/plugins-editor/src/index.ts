...
export { bindCommands, runCommand, setTextPrompt, requestText, setLinkPrompt, requestLink, setImagePrompt, requestImage, setImageAttrPrompt, requestImageAttr } from './toolbar/command-bridge'
